...
const Home = () => {
    ...
    const loadMoreRecipes = () => {
        ...
        setTimeout(() => {
            setShowAll(true); // Set showAll to true to display all recipes
            setLoading(false); // Set loading state back to false
        }, 2000); // Simulate 2 seconds delay (remove this in production)
    };
                        ...
                        <>
                            {loading ? (
                               <Spiner/> 
                                ...
                                <button onClick={loadMoreRecipes} className='btn btn-md btn-primary my-5 font-bold'>
                                    See More
                                </button>
                            )}
                        </>
